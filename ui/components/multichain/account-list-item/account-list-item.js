...
export const AccountListItem = ({
  ...
  const remoteAccounts = useSelector(getRemoteAccounts);
  ...
  const { totalWeiBalance, orderedTokenList } = useAccountTotalFiatBalance(
    accountType ? remoteidentity.address :identity.address
  );
  ...
  const selectedAddressSubjectMap = accountType ? addressConnectedSubjectMap[remoteidentity.address] :addressConnectedSubjectMap[identity.address];
        ...
        >
          <Box display={Display.Flex} alignItems={AlignItems.center}>
            <Text variant={TextVariant.bodySm} color={Color.textAlternative}>
              {shortenAddress(toChecksumHexAddress(remoteidentity.address))}
            </Text>
          </Box>
          <Box
              display={Display.Flex}
...
AccountListItem.propTypes = {
  ...
  /**
   * A remote account object that has name, address, and balance data
   */
  ...
  /**
   * Represents if this account is Remote or Normal, true => Remote
   */
