...
const ACTION_MODES = {
  ...
  ADD: 'add',
  // Displays the remote account form controls
  REMOTE: 'remote',
  ...
  return (
    <Modal isOpen onClose={onClose}>
      ...
      >
        ...
        {actionMode === ACTION_MODES.REMOTE ? (
          <Box paddingLeft={4} paddingRight={4} paddingBottom={4}>
            <RemoteAccount
              onActionComplete={(confirmed) => {
                if (confirmed) {
            ...
            <Box marginTop={4}>
              <ButtonLink
                ...
                onClick={() => {
                  ...
                  setActionMode(ACTION_MODES.REMOTE);
                }}
                data-testid="multichain-account-menu-popover-remote-account"
              >
                {t('remoteAccount')}
              </ButtonLink>
            </Box>
