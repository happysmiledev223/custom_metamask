...
export const ADD_NEW_INTERNAL_ACCOUNT = 'ADD_NEW_INTERNAL_ACCOUNT';
// unlock screen
...
export const ADD_REMOTE_ADDRESS = 'ADD_REMOTE_ADDRESS';
export const SET_SELECTED_REMOTEACCOUNT = 'SET_SELECTED_REMOTEACCOUNT';
export const UPDATE_REMOTE_AMOUNT = 'UPDATE_REMOTE_AMOUNT';
export const TOGGLE_MAX_MODE = 'TOGGLE_MAX_MODE';
export const SET_REMOTE_BALANCE = 'SET_REMOTE_BALANCE';
