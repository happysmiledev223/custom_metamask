...
import { CryptoAccount, ETHSignature, EthSignRequest, DataType } from '@keystonehq/bc-ur-registry-eth';
import { stringify, v4 } from 'uuid';
import { TransactionFactory } from '@ethereumjs/tx';
import rlp from 'rlp';

class RemoteAccountKeyringProvider extends EventEmitter {
  constructor() {
    super();
    ...
    if (RemoteAccountKeyringProvider.instance) {
      return RemoteAccountKeyringProvider.instance;
    }
    ...
    RemoteAccountKeyringProvider.instance = this;
  }

}

class RemoteKeyring extends BaseKeyring {
  constructor(opts) {
    super(opts);

    this.getInteraction = () => {
      return new RemoteAccountKeyringProvider();
    };
    ...
    if (RemoteAccountKeyring.instance) {
      RemoteAccountKeyring.instance.deserialize(opts);
      return RemoteAccountKeyring.instance;
    }

    RemoteAccountKeyring.instance = this;
  }
...
RemoteKeyring.type = "Remote Wallet";
